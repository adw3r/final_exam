                    ...
                    <a href={'https://t.me/Alexey_naidiuk'} target="_blank" rel="noreferrer" className={'social_icon'}
                       title={'telegram'}>
                        <svg
                            ...
                            viewBox="0 0 24 24"
                            fill="#fff" height={'24px'} width={'24px'}
                        >
